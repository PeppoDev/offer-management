...
import com.offer.management.offermanagement.modules.company.dto.CreateJobDTO;
...
public class JobController {
    ...
    public ResponseEntity<JobEntity> create(@Valid @RequestBody CreateJobDTO createJobDTO, HttpServletRequest request) {
        ...
        var jobEntity = JobEntity.builder().benefits(createJobDTO.getBenefits())
                ...
                .level(createJobDTO.getLevel()).companyId(UUID.fromString(companyId.toString())).build();
